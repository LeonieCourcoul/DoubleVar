...
#' @param nb.knots.splines
#' @param nb_pointsGK
#' @param formSlopeFixed
#' @param formSlopeRandom
...
#'
#' @examples
DoubleVar_IDM <- function(formFixed, formRandom, formGroup, formGroupVisit, formSurv,
                          Time, deltas, timeVar, data.long, correlated_re = FALSE,
  ...
  formSurv_01 <- formSurv[["formSurv_01"]]
  formSurv_02 <- formSurv[["formSurv_02"]]
  formSurv_12 <- formSurv[["formSurv_12"]]
  hazard_baseline_01 <- hazard_baseline[["hazard_baseline_01"]]
  hazard_baseline_02 <- hazard_baseline[["hazard_baseline_02"]]
  hazard_baseline_12 <- hazard_baseline[["hazard_baseline_12"]]
  sharedtype_01 <- sharedtype[["sharedtype_01"]]
  sharedtype_02 <- sharedtype[["sharedtype_02"]]
  sharedtype_12 <- sharedtype[["sharedtype_12"]]
  ...
  if(length(all.vars(formSurv_12))==0){
    ...
    if(hazard_baseline_01 == "Exponential" || hazard_baseline_01 == "Weibull" ){
      ...
      alpha_01 <- mod_surv$coefficients[1:length(all.vars(formSurv_01))]
      ...
      if(hazard_baseline_01 == "Gompertz"){
        ...
        gompertz.1_01 <- mod_surv$res[2,1]
        ...
        if(hazard_baseline_01 == "Splines"){
          ...
          if(length(tmp_model$coefficients) == 2){
            ...
            alpha_01 <- tmp_model$coefficients[1:(length(all.vars(formSurv_01))-1)]
          }
        }
      }
    }
    if(hazard_baseline_02 == "Exponential" || hazard_baseline_02 == "Weibull" ){
      mod_surv <- survreg(Surv_02, data = data.id, dist = "exponential")
      alpha_02 <- mod_surv$coefficients[1:length(all.vars(formSurv_02))]
      ...
      if(hazard_baseline_02 == "Gompertz"){
        ...
        gompertz.1_02 <- mod_surv$res[2,1]
        ...
        if(hazard_baseline_02 == "Splines"){
          ...
          if(length(tmp_model$coefficients) == 2){
            ...
            alpha_02 <- tmp_model$coefficients[1:(length(all.vars(formSurv_02))-1)]
          }
        }
      }
    }
    if(hazard_baseline_12 == "Exponential" || hazard_baseline_12 == "Weibull" ){
      mod_surv <- survreg(Surv_12, data = data.id, dist = "exponential")
      alpha_12 <- mod_surv$coefficients[1:length(all.vars(formSurv_12))]
      ...
      if(hazard_baseline_12 == "Gompertz"){
        ...
        gompertz.1_12 <- mod_surv$res[2,1]
        gompertz.2_12 <- mod_surv$res[1,1]
        alpha_12 <- NULL
        if(length(all.vars(formSurv_12)) >=1){
          alpha_12 <- mod_surv$res[3:(3+length(all.vars(formSurv_12))-1),1]
        }
      }
      else{
        if(hazard_baseline_02 == "Splines"){
          ...
          if(length(tmp_model$coefficients) == 2){
            ...
            alpha_12 <- tmp_model$coefficients[1:(length(all.vars(formSurv_12))-1)]
          }
        }
      }
    }
  ...
  B_T_01 = NULL; B_T_02 = NULL ; B_T_12 = NULL
  Bs_T_01 = NULL; Bs_T_02 = NULL; Bs_T_12 = NULL; X_GK_L_R = NULL; U_GK_L_R = NULL
  Xslope_GK_L_R = NULL; Uslope_GK_L_R = NULL;
  st_L_R = NULL; Bs_L_R_01 = NULL; Bs_L_R_02 = NULL; Bs_L_R_12 = NULL; Time_T0 = NULL
  ...
  if(length(id.Case1)>0){
    ...
    Xslope_0_LR <- c()
    Uslope_0_LR <- c()
    Bs_0_LR_01 <- c(); Bs_0_LR_02 <- c(); Bs_0_LR_12 <- c()
    ...
    Case1 <- list( "delta2" = data.id.Case1$delta2, "Z_01" = Z_01, "Z_02" = Z_02, "Z_12" = Z_12, "Time_T" = data.id.Case1$Time_T,
                   ...
                   "st_L_R" = st_L_R, "Bs_L_R_01" = Bs_L_R_01, "Bs_L_R_02" = Bs_L_R_02, "Bs_L_R_12" = Bs_L_R_12, "Time_T0" = data.id.Case1$Time_T0,
  ...
  message(paste(length(id.Case1),"indiduals",sep=" "))
  ...
  message(paste(length(id.Case1bis),"indiduals",sep=" "))
  ...
  message(paste(length(id.Case2),"indiduals",sep=" "))

  message("Case3")
  Case3 <- NULL
  st_T = NULL; X_GK_T = NULL; U_GK_T = NULL; Xslope_GK_T = NULL; Uslope_GK_T = NULL;
  X_T = NULL; U_T = NULL; Xslope_T = NULL; Uslope_T = NULL; B_T_01 = NULL; B_T_02 = NULL; B_T_12 = NULL;
  Bs_T_01 = NULL; Bs_T_02 = NULL; Bs_T_12 = NULL; X_GK_L_T = NULL; U_GK_L_T = NULL;
  Xslope_GK_L_T = NULL; Uslope_GK_L_T = NULL; Time_L_T = NULL;
  st_L_T = NULL; B_GK_L_T_01 = NULL; B_GK_L_T_02 = NULL; B_GK_L_T_12 = NULL; Time_T0 = NULL;
  st_T0 = NULL; X_GK_T0 = NULL; U_GK_T0 = NULL; Xslope_GK_T0 = NULL; Uslope_GK_T0 = NULL;
  Bs_T0_01 = NULL; Bs_T0_02 = NULL
  if(length(id.Case3)>0){
    ...
    Xslope_0_LT <- c()
    Uslope_0_LT <- c()
    Bs_0_LT_01 <- c(); Bs_0_LT_02 <- c(); Bs_0_LT_12 <- c()
    ...
    Case3 <- list( "delta2" = data.id.Case3$delta2, "Z_01" = Z_01, "Z_02" = Z_02, "Z_12" = Z_12, "Time_T" = data.id.Case3$Time_T,
                   ...
                   "st_L_T" = st_L_T, "Bs_L_T_01" = B_GK_L_T_01, "Bs_L_T_02" = B_GK_L_T_02, "Bs_L_T_12" = B_GK_L_T_12, "Time_T0" = data.id.Case3$Time_T0,
                   "st_T0" = st_T0, "X_GK_T0" = X_GK_T0, "U_GK_T0" = U_GK_T0, "Xslope_GK_T0" = Xslope_GK_T0, "Uslope_GK_T0" = Uslope_GK_T0,
                   "Bs_T0_01" = Bs_T0_01, "Bs_T0_02" = Bs_T0_02,
