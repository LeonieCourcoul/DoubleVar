...
double log_llh_2var_longInd(int S, List sigma_inter_intra, arma::mat X_base_i, arma::mat U_base_i,
                            arma::vec y_i, int len_visit_i, arma::vec offset_ID_i, arma::vec beta,
                            arma::mat b_y){
