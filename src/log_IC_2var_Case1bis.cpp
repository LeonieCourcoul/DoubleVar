...
double log_IC_2var_Case1bis(arma::vec sharedtype, List HB, arma::vec Gompertz, arma::vec Weibull,
                           ...
                           arma::rowvec Xslope_L_i, arma::vec Uslope_L_i, arma::mat X_GK_L_i, arma::mat U_GK_L_i, arma::mat Xslope_GK_L_i,
  ...
  if(dep_var_inter_01){
    h_01_L_i = h_01_L_i%exp(alpha_inter_01*sigma_inter);
    etaBaseline_01_L_i = etaBaseline_01_L_i + alpha_inter_01*sigma_inter;
    if(left_trunc){
      etaBaseline_01_T0_i = etaBaseline_01_T0_i + alpha_inter_01*sigma_inter;
    }
  }
  if(dep_var_inter_02){
    etaBaseline_02_L_i = etaBaseline_02_L_i + alpha_inter_02*sigma_inter;
    if(left_trunc){
  ...
  if(dep_var_intra_01){
    h_01_L_i = h_01_L_i%exp(alpha_intra_01*sigma_intra);
    etaBaseline_01_L_i = etaBaseline_01_L_i + alpha_intra_01*sigma_intra;
    if(left_trunc){
      etaBaseline_01_T0_i = etaBaseline_01_T0_i + alpha_intra_01*sigma_intra;
    }
  }
  if(dep_var_intra_02){
    etaBaseline_02_L_i = etaBaseline_02_L_i + alpha_intra_02*sigma_intra;
    if(left_trunc){
